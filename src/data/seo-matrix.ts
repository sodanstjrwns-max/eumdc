...
export const SEO_TREATMENTS: TreatmentInfo[] = [
  ...
  },
  {
    ...
    shortBenefit: '글로벌 1위 투명교정 — 눈에 안 띄게, 일상 그대로',
    searchVariants: ['인비절라인', '투명교정', '인비절라인 비용', '인비절라인 가격', '인비절라인 잘하는곳', '투명교정 추천', '인비절라인 인증의'],
    duration: '경증 6~12개월, 일반 12~24개월',
    whyChoose: [
      '✨ 인비절라인 공인 의료진 — 정품 진단·치료',
    ...
    faqs: [
      { q: '인비절라인은 정말 눈에 안 보이나요?', a: '투명한 폴리우레탄 소재로 가까이서도 거의 보이지 않습니다. 직장·면접·결혼식 등 중요한 자리에서도 부담 없이 진행할 수 있습니다.' },
      { q: '인비절라인 비용은 얼마인가요?', a: '치료 난이도와 장치 단계(stage) 수에 따라 다릅니다. 초진 진단 후 정확한 비용을 안내드리며 분할 결제도 가능합니다.' },
      { q: '인비절라인 vs 일반 교정 차이는?', a: '인비절라인은 탈착식·투명·디지털 시뮬레이션이 강점이고, 일반 브라켓은 복잡한 케이스에 강합니다. 라이프스타일·증례에 따라 맞춤 추천드립니다.' },
  ...
  },
  {
    ...
    faqs: [
      { q: '성인도 교정 가능한가요?', a: '네, 가능합니다. 50대 이상도 잇몸뼈 상태가 양호하면 교정 가능합니다. 인비절라인은 성인에게 특히 인기가 많습니다.' },
      { q: '교정 비용은 얼마인가요?', a: '장치 종류(인비절라인/설측/클리피씨/메탈)와 난이도에 따라 다릅니다. 초진 진단 후 정확한 비용을 안내드립니다.' },
  ...
  },
  {
    ...
    faqs: [
      { q: '잇몸이 자주 붓고 피가 나요. 풍치인가요?', a: '치은염 또는 초기 치주염일 가능성이 높습니다. 방치하면 잇몸뼈 손실로 이어질 수 있으니 검진을 권장합니다.' },
