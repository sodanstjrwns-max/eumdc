      ...
      <section class="visit-section" id="tabPrice" style="display:none">
        <div class="container-wide">
          ...
          <div class="price-notice">
            <p>※ 위 금액은 <strong>비급여 기준 금액</strong>이며, 환자 상태·재료·치아 위치에 따라 달라질 수 있습니다.</p>
            <p>※ 부가세(10%)는 치아 미백·라미네이트 등 일부 항목에 별도 표기되어 있습니다.</p>
            <p>※ 정확한 비용은 내원 후 진단·상담을 통해 최종 안내해 드립니다.</p>
            <p>※ 이 수가표에 없는 진료 항목은 <a href="tel:051-206-5888" class="text-link">051-206-5888</a>로 문의해 주세요.</p>
          </div>
        </div>
      </section>
