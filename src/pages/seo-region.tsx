      ...
      <section class="page-hero-mini">
        <div class="container-wide">
          ...
          <p class="page-subtitle">
            ...
            <strong>임플란트·인비절라인·라미네이트·글로우네이트·치아교정</strong> 전문 디지털 치과입니다.
            가까운 지역에서 이음치과를 찾으세요.
          </p>
        </div>
      </section>
        ...
        <div class="container-wide">
          <div class="regions-intro-box">
            ...
            <p>
              ...
              디지털 치과입니다. CBCT·디지털 가이디드 서저리·인비절라인 다이아몬드 제공자·자체 개발 <strong>글로우네이트</strong> 시술 등
            ...
            <ul class="regions-intro-features">
              <li><strong>5대 핵심 진료</strong> — 임플란트, 인비절라인, 라미네이트, 글로우네이트, 치아교정</li>
