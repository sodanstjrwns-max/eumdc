    ...
    <div id="app">
      ...
      <section class="section services-horizontal" id="section-services">
        ...
        <div class="horizontal-wrap">
          <div class="horizontal-track" id="horizontalTrack">
            ...
            <div class="h-card"><div class="h-card-inner"><span class="h-card-num">04</span><h3 class="h-card-title">일반진료</h3><p class="h-card-desc">충치, 신경치료, 사랑니, 잇몸치료, 스케일링. 기본에 충실하게.</p><div class="h-card-features"><span>충치 · 신경치료</span><span>사랑니 발치</span><span>잇몸 · 스케일링</span></div><div class="h-card-arrow">→</div></div></div>
            <div class="h-card"><div class="h-card-inner"><span class="h-card-num">05</span><h3 class="h-card-title">턱관절</h3><p class="h-card-desc">턱관절 통증, 소리, 개구제한을 정밀 진단. 물리치료와 체계적 프로토콜.</p><div class="h-card-features"><span>물리치료</span><span>교합 분석</span><span>맞춤 스플린트</span></div><div class="h-card-arrow">→</div></div></div>
          </div>
        </div>
      </section>
        ...
        <div class="container-wide">
          <div class="footer-top">
            <div class="footer-brand-logo">
              <img src="/static/images/symbol.png" alt="이음치과의원" class="footer-brand-symbol" width="48" height="53" loading="lazy" />
      ...
      <div class="floating-cta-group" id="floatingCtaGroup">
        ...
        <a href="https://m.place.naver.com/hospital/2005922467/booking" target="_blank" rel="noopener" class="floating-btn floating-naver" data-hover aria-label="네이버 예약">
          <span style="font-weight:800;font-size:13px;letter-spacing:-.02em">예약</span>
        </a>
