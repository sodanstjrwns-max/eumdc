...
export function subPageLayout(title: string, children: any) {
  return (
    <div id="app" class="sub-page">
          ...
          <div class="footer-top-grid">
            <div class="footer-brand-col">
              ...
              <div class="footer-sns">
                <a href="https://www.instagram.com/ieumdental/" target="_blank" rel="noopener" aria-label="인스타그램">
                ...
                <a href="https://map.naver.com/p/entry/place/2005922467" target="_blank" rel="noopener" aria-label="네이버 지도">
      ...
      <script src="/static/app.js?v=20260423h"></script>
      <script src="/static/sub.js?v=20260423h"></script>
      <script src="/static/gsap-init.js?v=20260423h"></script>
      <script src="/static/scroll-perf-patch.js?v=20260423h" defer></script>
    </div>
  )
}
